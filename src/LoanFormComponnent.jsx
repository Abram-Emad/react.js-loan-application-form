...
import FormModalComponnent from "./FormModalComponnent";
import { useState } from "react";

function LoanFormComponnent() {
  ...
  return (
    <div
      ...
      <FormModalComponnent errorMessage={errorMessage} isVisible={showModal}/>
    </div>
  );
}

export default LoanFormComponnent;
